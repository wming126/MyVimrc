...
* **The Basic**: If you want something small just copy [basic.vim](https://github.com/wming126/MyVimrc.git) into your ~/.vimrc and you will have a good basic setup
...
The awesome version includes a lot of great plugins, configurations and color schemes that make Vim a lot better. To install it simply do following from your terminal:
	...
	git clone https://github.com/wming126/MyVimrc.git ~/.vim_runtime
...
The basic version is just one file and no plugins. Just copy [basic.vim](https://github.com/wming126/MyVimrc.git) and paste it into your vimrc.
